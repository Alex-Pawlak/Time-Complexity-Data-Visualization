...
# Preview
For this demonstration, I created a database with 1000 items consisting of digits only, converted it into a csv file, performed all sorts and plotted the results on a simple to read graph.
